...
DEFAULT_STYLE_CONFIG: Dict[str, Any] = {
    ...
    "info_font_color": colors.darkgrey, # Changed from darkgrey to darkslategray
    ...
    "answer_font_color": colors.darkslategray, # Changed from darkslategrey
...
def _get_float_unit(value: Any, default_value: float, unit: float = 1.0) -> float:
    ...
    try:
        # Ensure value is not None before trying to convert
        if value is None:
            return default_value * unit # Apply unit to default if value is None
        return float(value) * unit
    except (ValueError, TypeError):
        return default_value * unit # Apply unit to default on error
...
class ExportSubmissionService:
    ...
    def export_structured_submission_to_pdf(
        ...
        try:
            ...
            # Dynamically create and add custom styles
            styles.add(ParagraphStyle(
                name='CustomFormTitle', fontName=str(styles_config["title_font_family"]),
                ...
                alignment=int(styles_config.get("title_alignment", DEFAULT_STYLE_CONFIG["title_alignment"])),
            ...
            styles.add(ParagraphStyle(
                name='CustomInfoLabel', fontName=str(styles_config["info_label_font_family"]),
            ...
            styles.add(ParagraphStyle(
                name='CustomInfoValue', fontName=str(styles_config["info_font_family"]),
                fontSize=_get_float_unit(styles_config["info_font_size"], DEFAULT_STYLE_CONFIG["info_font_size"]),
                textColor=_get_color(styles_config["info_font_color"], DEFAULT_STYLE_CONFIG["info_font_color"]),
            ))
            styles.add(ParagraphStyle(
                name='CustomQuestion', fontName=str(styles_config["question_font_family"]),
            ...
            styles.add(ParagraphStyle(
                name='CustomAnswer', fontName=str(styles_config["answer_font_family"]),
            ...
            styles.add(ParagraphStyle(
                name='CustomQACombined', fontName=str(styles_config["question_font_family"]),
                fontSize=_get_float_unit(styles_config["question_font_size"], DEFAULT_STYLE_CONFIG["question_font_size"]),
                textColor=_get_color(styles_config["question_font_color"], DEFAULT_STYLE_CONFIG["question_font_color"]),
                leftIndent=_get_float_unit(styles_config["question_left_indent"], DEFAULT_STYLE_CONFIG["question_left_indent"]),
                spaceBefore=_get_float_unit(styles_config["question_space_before"], DEFAULT_STYLE_CONFIG["question_space_before"]),
            ...
            styles.add(ParagraphStyle(
                name='CustomTableHeader', fontName=str(styles_config["table_header_font_family"]),
                ...
                alignment=TableStyle().commands[0][1] if styles_config.get("table_header_alignment", "CENTER").upper() == "CENTER" else (0 if styles_config.get("table_header_alignment", "CENTER").upper() == "LEFT" else 2), # 0=left, 1=center, 2=right
                leading=_get_float_unit(styles_config["table_header_font_size"], DEFAULT_STYLE_CONFIG["table_header_font_size"]) * 1.2,
                leftPadding=_get_float_unit(styles_config.get("table_header_padding", DEFAULT_STYLE_CONFIG["table_header_padding"]), DEFAULT_STYLE_CONFIG["table_header_padding"]),
                rightPadding=_get_float_unit(styles_config.get("table_header_padding", DEFAULT_STYLE_CONFIG["table_header_padding"]), DEFAULT_STYLE_CONFIG["table_header_padding"]),
                topPadding=_get_float_unit(styles_config.get("table_header_padding", DEFAULT_STYLE_CONFIG["table_header_padding"]), DEFAULT_STYLE_CONFIG["table_header_padding"]),
                bottomPadding=_get_float_unit(styles_config.get("table_header_padding", DEFAULT_STYLE_CONFIG["table_header_padding"]), DEFAULT_STYLE_CONFIG["table_header_padding"]),
            ))
            styles.add(ParagraphStyle(
                name='CustomTableCell', fontName=str(styles_config["table_cell_font_family"]),
                ...
                alignment=TableStyle().commands[0][1] if styles_config.get("table_cell_alignment", "LEFT").upper() == "CENTER" else (0 if styles_config.get("table_cell_alignment", "LEFT").upper() == "LEFT" else 2),
                leading=_get_float_unit(styles_config["table_cell_font_size"], DEFAULT_STYLE_CONFIG["table_cell_font_size"]) * 1.2,
                leftPadding=_get_float_unit(styles_config.get("table_cell_padding", DEFAULT_STYLE_CONFIG["table_cell_padding"]), DEFAULT_STYLE_CONFIG["table_cell_padding"]),
                rightPadding=_get_float_unit(styles_config.get("table_cell_padding", DEFAULT_STYLE_CONFIG["table_cell_padding"]), DEFAULT_STYLE_CONFIG["table_cell_padding"]),
                topPadding=_get_float_unit(styles_config.get("table_cell_padding", DEFAULT_STYLE_CONFIG["table_cell_padding"]), DEFAULT_STYLE_CONFIG["table_cell_padding"]),
                bottomPadding=_get_float_unit(styles_config.get("table_cell_padding", DEFAULT_STYLE_CONFIG["table_cell_padding"]), DEFAULT_STYLE_CONFIG["table_cell_padding"]),
            ))
            styles.add(ParagraphStyle(
                name='CustomSignatureLabel', fontName=str(styles_config["signature_label_font_family"]),
            ...
            styles.add(ParagraphStyle(
                name='CustomSignatureText', fontName=str(styles_config["signature_text_font_family"]),
            ...
            qa_layout = str(styles_config.get("qa_layout", "answer_below"))
            ...
            for ans_item in sorted(regular_answers, key=lambda a: a.question or ""):
                ...
                if qa_layout == "answer_same_line" and isinstance(ans_item.answer, str) and len(ans_val_p) <= answer_same_line_max_len and '\n' not in ans_val_p:
                    combined_text = f"<b>{q_text_p}:</b> <font color='{styles_config['answer_font_color'].hex()}'>{ans_val_p}</font>" # Basic HTML for color
            ...
            for q_text_choice, ans_list_choice in choice_answer_groups.items():
                ...
                if qa_layout == "answer_same_line" and len(ans_val_c_p) <= answer_same_line_max_len and '\n' not in ans_val_c_p:
                    combined_text_c = f"<b>{q_text_c_p}:</b> <font color='{styles_config['answer_font_color'].hex()}'>{ans_val_c_p}</font>"
            ...
            table_cell_padding_val = _get_float_unit(styles_config.get("table_cell_padding", DEFAULT_STYLE_CONFIG["table_cell_padding"]), DEFAULT_STYLE_CONFIG["table_cell_padding"])
            table_grid_color_val = _get_color(styles_config.get("table_grid_color"), DEFAULT_STYLE_CONFIG["table_grid_color"])
            table_grid_thickness_val = _get_float_unit(styles_config.get("table_grid_thickness"), DEFAULT_STYLE_CONFIG["table_grid_thickness"])
            table_header_bg_color_val = _get_color(styles_config["table_header_bg_color"], DEFAULT_STYLE_CONFIG["table_header_bg_color"])
            ...
            for table_id_cb, content_cb in cell_based_tables_data.items():
                ...
                for data_row_idx in data_row_indices: 
                    table_rows_styled_cb.append([Paragraph(str(content_cb['cells'].get((data_row_idx, col_idx), "")), styles['CustomTableCell']) for col_idx in sorted_cols])
                if table_rows_styled_cb: 
                    ...
                    story.append(rl_table_cb); story.append(Spacer(1, 0.15*inch))
            ...
            for table_name_pb, info_pb in pattern_based_tables_data.items():
                ...
                if data_for_pb_table_styled:
                    ...
                    story.append(rl_table_pb); story.append(Spacer(1, 0.15*inch))
                ...
                if sig_attachments:
                    ...
                    if signatures_alignment.lower() == "horizontal" and len(sig_attachments) > 1:
                        ...
                        for idx, att in enumerate(sig_attachments):
                            ...
                            sig_block_elements_list.append(Spacer(1,2*pt)); sig_block_elements_list.append(Paragraph("<b>___________________________</b>", styles['CustomSignatureText'])); sig_block_elements_list.append(Paragraph(f"<b>Signed by:</b> {sig_author}", styles['CustomSignatureText'])); sig_block_elements_list.append(Paragraph(f"<b>Position:</b> {sig_position}", styles['CustomSignatureText']))
                        ...
                        for sig_row_group_list in sig_rows_data_list:
                            ...
                            sig_table_this_row.setStyle(TableStyle([('VALIGN', (0,0), (-1,-1), 'TOP'), ('LEFTPADDING', (0,0), (-1,-1), 2*pt), ('RIGHTPADDING', (0,0), (-1,-1), 2*pt)]))
                        ...
                        for att in sig_attachments:
                            ...
                            story.append(Spacer(1,2*pt)); story.append(Paragraph("<b>___________________________</b>", styles['CustomSignatureText'])); story.append(Paragraph(f"<b>Signed by:</b> {sig_author_v}", styles['CustomSignatureText'])); story.append(Paragraph(f"<b>Position:</b> {sig_position_v}", styles['CustomSignatureText'])); story.append(Spacer(1, _get_float_unit(styles_config.get("signature_space_between_vertical", DEFAULT_STYLE_CONFIG["signature_space_between_vertical"]))))
    ...
    # Note: Older helper methods like _consolidate_table_questions, _parse_table_structure,
    # _format_answer_simple, _format_answer, _format_answer_by_type, _format_table_answer,
    # _format_dropdown_answer are omitted as their core functionalities have been integrated
    # into the main export_structured_submission_to_pdf method or are no longer directly
    # relevant to this refactored and customizable version. If any external code relies on them,
    # they would need to be re-added or that external code updated.
