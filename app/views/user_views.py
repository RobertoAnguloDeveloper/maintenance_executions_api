...
# No @jwt_required() or @PermissionManager decorators for truly unrestricted access.
...
def get_all_users_unrestricted_view():
    """
    Get ALL active users from ALL environments without permission restrictions.
    Provides a minimal set of attributes: id, full_name, username, email.
    Optionally include soft-deleted users via query parameter 'include_deleted=true'.
    ...
    try:
        ...
        # Uses the UserController method that calls the unrestricted service method
